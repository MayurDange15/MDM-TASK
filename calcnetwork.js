function IMPiViewModel() {
	...
	self.drnstat = ko.observable("mean");
	...
	self.start_job = function() {
		if(site.User())
		{
    	    try
            {
    		    ...
    		    {
					traj_file = document.getElementById('check_trajsize_calnet');
    		    ...
    		    {
					url_file = document.getElementById('check_Urltrajsize_calnet');
    		    ...
    		    formData.append('step_cn', self.step_cn());
    		    formData.append('drnstat', self.drnstat());
...
var changeTopologyDiv_cn = function(div) {
	if(div == "upload") {
		$("#upload_topology_cn").addClass('panel-info');
		$("#select_topology_cn").removeClass('panel-info');
	}
	else if(div == "select") {
		$("#upload_topology_cn").removeClass('panel-info');
		$("#select_topology_cn").addClass('panel-info');
	}
}

var changeTrajectoryDiv_cn = function(div) {
	if(div == "upload") {
		$("#upload_trajectory_cn").addClass('panel-info');
		$("#url_trajectory_cn").removeClass('panel-info');
		$("#select_trajectory_cn").removeClass('panel-info');
	}
	else if(div == "url") {
		$("#upload_trajectory_cn").removeClass('panel-info');
		$("#url_trajectory_cn").addClass('panel-info');
		$("#select_trajectory_cn").removeClass('panel-info');
	}
	else if(div == "select") {
		$("#upload_trajectory_cn").removeClass('panel-info');
		$("#url_trajectory_cn").removeClass('panel-info');
		$("#select_trajectory_cn").addClass('panel-info');
	}
}
...
ko.applyBindings(impi, document.getElementById("cn"));